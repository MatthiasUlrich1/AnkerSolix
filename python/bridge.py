...
async def _set_ev_charger_schedule_control(
    ...
    if control in _TIME_CONTROLS or control == _WEEKEND_MODE_CONTROL:
        ...
        from ev_charger_comfort import (  # noqa: PLC0415
            ...
            is_ev_light_off_schedule_command,
        )
